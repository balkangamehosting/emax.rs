...
if(!defined('HOST')) define("HOST", '185.61.137.168');
if(!defined('DBNAME')) define("DBNAME", 'emaxrsmh_egame');
if(!defined('DBUSER')) define("DBUSER", 'emaxrsmh_egame'); 
if(!defined('DBPASS')) define("DBPASS", 'emaxrsmh_egame');
if(!defined('CHARSET')) define("CHARSET", '');
if(!defined('DOMEN')) define("DOMEN", 'http://egame.e-max.rs/');

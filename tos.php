...
<body>
	...
	<article>
		<div class="uslovi_tos" style="padding: 10px;">
			<center>
				<div class="tos_naslov"><h3>Opšti uslovi za korišćenje usluga e-Game.me</h3></div>
			</center>
			...
			<p>
				...
				kojima EG hosting pruža usluge na oslovu dodeljenih dozvola.
				
				<br /> 

				<strong>1.</strong> Opšti uslovi objavljeni su na internet sajtu e-game.me, svaki korisnik je
				dužan da ih procita pre narudžbe, time izbegava nesporazume.
				
				<br />

				<strong>1.2.</strong> e-Game game hosting pruža usluge Game Servera kao svoju osnovnu uslugu. Usluge web
				...
				<strong>1.3.</strong> e-Game hosting zadržava pravo izmene "Ugovora o korišcenju usluga" bez prethodnog
				...
				e-Game game hosting zadržava pravo suspenzije i otkazivanja svojih usluga korisnicima koji krše
				pravila (tacka 3, 4)
			</p>
			...
			<p>
				...
				<strong>2.1.</strong> Ugovor se zakljucuje na neodredeno vreme, osim ako drugacije nije definisano od strane korisnika i e-Game game hostinga (posebni vremenski ugovori na 1. god. i sl.)
			</p>
			...
			<p>
				...
				licima. e-Game game hosting ne odgovara za štetu nastalu pristupanjem trecih lica na nalog.
			</p>
			...
			<p>
				...
				Usluge Korišcenja e-Game usluga.
				Narudžba tj. zahtjev za zasnivanje korisnickog odnosa se podnosi narudžbom preko
				zvanicnog
				sajta e-Game.me gde je neophodno upisati tacne podatke (ime, prezime,
				adresa,
				email, broj telefona).
				...
				Korisnik nije dužan obavestiti e-Game game hosting o otkazivanju usluge za koju nema
				vremenski
			...
			<p>
				...
				cenovniku
				Provajdera koji je dostupan na adresi e-Game.me i smatra se sastavnim delom
				ovog
				Ugovora.
				...
				<strong>5.2.</strong> e-Game zadržava pravo da jednostrano izmeni cenovnik kojim odreduje visinu naknade o
				cemu
				ce blagovremeno na uobicajen nacin obavestiti korisnika.
				
				<br />

				<strong>5.3.</strong> Sve usluga e-Game provajdera su iskljucivo PRE­PAID, što znaci, da korisnik placa za
				definisani
			...
			<p>
				<strong>6.</strong> e-Game poštuje Vašu privatnost i ne vrši pregled fajlova na hostingu osim u slucaju Vašeg
				pismenog
				zahteva.
				...
				Zabranjeno je da bilo ko iz e-Game game hostinga uzima delove Vaših skripti, sajtova i ostale
			...
			<p>
				e-Game game hosting je osloboden odgovornosti prema bilo kome za bilo kakvu štetu – direktnu,
			...
			<p>
				<strong>9.</strong> Komunikacija izmedu korisnika i e-Game hosting provajdera vrši se iskljucivo elektronski, preko zvanicnih email adresa za podršku koje možete videti na sajtu i ticketa za podršku kao i ostalih vidova komunikacije dostupnih na sajtu.
			</p>
			...
			<span>
				...
				<br /> <br />
				Original iz: 01.11.2018. <br /> Prva izmena: 09.12.2018. <br /> Zadnja izmena: 12.12.2018.
				<br />
				U Paris,France 01.11.2018

...
<br>			
				    ...
				    <label for="prezime">STANJE </label>
                                    <input disabled type="text" name="prezime" value="<?php echo userMoneyWithValute(userMoney($_SESSION['userid']), userCountry($_SESSION['userid'])); ?>" style="margin-left: 70px;"> <br />

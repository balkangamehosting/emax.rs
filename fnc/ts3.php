...
<form action="/fnc/buy.php?task=buy_ts3" method="POST" class="form-horizontal">
		...
		<div class="NarServerPrviDeo">
			...
			<li style="display:block;">
				...
				<select name='odaberiteslotove' class='NarServer lite' id='slotovi'  onChange='izracunajCenu();'>
					...
					<option value="5">5 slotova</option>
					<option value="10">10 slotova</option>
					...
					<option value="300">300 slotova</option>
					<option value="350">350 slotova</option>
					<option value="400">400 slotova</option>

...
$p->paypal_url = 'https://www.paypal.com/mep/dashboard';   // testing paypal url
...
if (!isset($_GET['action']) || empty($_GET['action'])) $_GET['action'] = 'process';  
...
switch ($_GET['action']) {
   ...
   case 'uspesno':      // Order was successful...
	  ...
	  $ammount = $_REQUEST['amount'];
	  
      mysql_query("UPDATE `klijenti` SET `novac`=`novac`+'{$ammount}' WHERE `klijentid`='$_SESSION[userid]'");
	  
	  header("Location: /home");
      //echo "Postovani, upsesno ste narucili vas Game Server! <br/> Molimo javite se nasoj administraciji!";
   ...
   case 'ipn':          // Paypal is calling page for IPN validation...
      ...
      if ($p->validate_ipn()) { 
         ...
         $to = 'roksandaalizoti97@gmail.com';    //  your email

...
<form action="/fnc/buy.php?task=buy_sinus" method="POST" class="form-horizontal">
		...
		<div class="NarServerPrviDeo">
			...
			<li style="display:block;">
				...
				<select name='odaberiteigru' class="NarServer">
					<option value='ts3'>SinusBot</option>
				</select>	
			</li>
			...
			<li style="display:block;">
				...
				<select name='odaberiteslotove' class='NarServer lite' id='slotovi'  onChange='izracunajCenu();'>
					<option value='0'>Broj botova</option>
					<option value="2">2 bota</option>
					<option value="4">4 bota</option>
					<option value="6">6 botova</option>
					<option value="8">8 botova</option>
					<option value="10">10 botova</option>
				</select>
...
<div id="pay_naruci" style="position:absolute;right:15px;bottom:50px;">
	<form name="paypalForm" action="/_buy/paypal.php" method="POST">
		<input type="hidden" name="id" value="CS">
		<input type="hidden" name="CatDescription" value="Buying Counter-Strike 1.6 game servers">

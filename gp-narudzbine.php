					...
					<th>Cena</th>
                                    ...
                                    <?php  
                                        ...
                                        while($row = mysql_fetch_array($gp_obv)) { 
                                            ...
                                            if ($lokacija == "4") {
                                                $lokacija = "<img src='/assets/img/icon/country/RS.png'>";
                                            } else {
                                                $lokacija = "<img src='/assets/img/icon/country/RS.png'>";
                                            }
											
                                            if ($game == "Counter-Strike 1.6") {
                                                $game = "<img src='/img/icon/game2/game-cs.png'> Counter-Strike 1.6";
                                            } else if ($game == "SinusBot") {
                                                $game = "<img src='/img/icon/game2/game-sinusbot.png'> Sinus Bot";
                                            }

				            else if ($game == "Team-Speak 3") {
                                                $game = "<img src='/img/icon/game2/game-teamspeak.png'> Team Speak";
                                            }

                                            else if ($game == "FastDL") {
                                                $game = "<img src='/img/icon/game2/game-fdl.png'> FastDL";
                                            }

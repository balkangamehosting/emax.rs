	                ...
	                <div id="server_info_infor2">
	                    ...
	                    <div class="gp-home">
	                        ...
	                        <h3 style="font-size: 12px;">
	                            Dobrodosli u e-Game Support panel
	                            <br/>Ovde mozete otvarati nove tikete ukoliko vam treba pomoc ili podrska oko servera.
	                        </h3>

	                        <div class="supportAkcija right">
	                            <li>                                <a href="gp-newtiket.php" class="btn"><i class="fa fa-refresh"></i> Novi tiket</a>
                            </li>
                        </div>
                        <div id="tiket_body">   

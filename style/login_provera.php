				...
				<form action="/process.php?task=login" method="POST" autocomplete="off">
					<li class="inline" style="float:right;display:block;">
						<ul class="inline">
							...
							<div id="loginBox">
								<li><a href="demo_login.php?email=demo@e-game.me&pass=demo1337">DEMO</a></li>
...
</span> <a href="ts3server://ts.e-game.me" style="color: white;">TS.E-GAME.ME</a>
</div>		
</div>
	<?php } else { ?>
		<div class="login_form">
...
<div id="space" style="margin-top: 250px;"></div>